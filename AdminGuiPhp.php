...
$sql = "select clientName, clientAreaCode, clientPhone, position, event.id, passwords.id, passwordEnc from passwords, event, client where client.eventID = passwords.id and passwords.passwordEnc='".$md5."';";
$res = mysql_query($sql);
echo(mysql_error());
